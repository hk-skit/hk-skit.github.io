...
Off the keyboard, I'm raising a toddler, picking up the ukulele, walking most mornings, and travelling whenever I can — preferably hills and beaches. I binge documentaries, and occasionally ramble at [smellycode](https://smellycode.com).`,
  ...
  work: [
    ...
    },
    {
      company: "Greytip",
      blurb:
        "greytHR is Greytip's HR & payroll software suite. I revamped greytHR's Employee Self Service (ESS) portal — the employee-facing app for payslips, leave, and attendance — and built Employee Onboarding, its new-hire-onboarding product, from scratch.",
      highlights: [
